package com.altamirano.fabricio.core.simpleSwipe;
...
abstract class SwipeToValidateAdapter(
    var context: Context,
    ...
    private var listenerOnTouch: View.OnTouchListener
    ...
    init {
        ...
        listenerOnTouch = View.OnTouchListener { _, event ->
